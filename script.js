...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "Welcome to my profile. Mate. I'm studying Python, C#, Java, and JavaScript—with Python being the language I know best and feel most comfortable with.",
    "\"Hello, World!\""
  ];
  let bioText = '';
  let bioIndex = 0;
